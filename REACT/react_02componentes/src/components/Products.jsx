...
{/*Comente esta linea de codigo porque fue la que use para el ejemplo de props estructurados.
const Products = (props) =>
*/}
const Products = ({img, name, description, price}) => {
    return (
        <>
            {/*Agregando las propiedades directamente al componente, pero no se modifican
        las propiedades al importar el Componente en App.jsx, es decir, se repite la
        misma información
        <div className="cards">
            ...
            {/*Props estructurados, puedo asignar diferentes propiedades a un div, sin tener
que generar muchos props, solamente usando la palabra reservada 'props' como parametro
de la funcion
*Quiero modificar varias propiedades, puedo mandar a llamar las props dentro de cada
elemento como si fueran metodos
        <div className="cards">
            <div className="products--card">
