...
public class Employee {	
 //1. Encapsular Atributos o propiedades utilziando un modificador privado
...
//2.- Encapsular Método constructor. Tiene el mismo nombre que la clase, no returna nadam recibie parámetros (atributos) y los asigna a variables del constructor (this)
...
public Employee(String nombre, String apellido, int id, double salario, String puesto){ 
	...
	//3.Encapsular Métodos de comportamiento
